# Generated by Django 4.2.9 on 2024-02-25 05:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(default=False, max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('board_member', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='board_projects', to=settings.AUTH_USER_MODEL)),
                ('developers', models.ManyToManyField(related_name='projects', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Task',

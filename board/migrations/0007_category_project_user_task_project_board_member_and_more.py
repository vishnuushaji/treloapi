...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('board', '0006_remove_task_categories_remove_comment_task_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('developer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to='board.user')),
            ],
        ),
        migrations.AddField(
            model_name='project',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='board.user')),
            ],
        ),
